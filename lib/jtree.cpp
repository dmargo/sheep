...
template void JTree::insertSequence(GraphWrapper const &, std::vector<vid_t> const &);
template void JTree::insertSequence(GraphWrapper const &, std::vector<vid_t> const &, Options);
template bool JTree::isValid(GraphWrapper const &, std::vector<vid_t> const &, Options) const;
